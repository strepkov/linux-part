...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'mainController.wast';
  var wasmBinaryFile = 'mainController.wasm';
  var asmjsCodeFile = 'mainController.temp.asm.js';
...
STATICTOP = STATIC_BASE + 25776;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { ___cxx_global_var_init_44() } }, { func: function() { ___cxx_global_var_init_45() } }, { func: function() { __GLOBAL__sub_I_mainController_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
var real___GLOBAL__sub_I_mainController_cpp = asm["__GLOBAL__sub_I_mainController_cpp"]; asm["__GLOBAL__sub_I_mainController_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_mainController_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_mainController_cpp = Module["__GLOBAL__sub_I_mainController_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_mainController_cpp"].apply(null, arguments) };
